...
namespace paradigm_ehb.CommandCenter.Core.Interfaces
{
    public interface IAgentEndpointFactory
    {
        ...
        public AgentEndpoint Create(string ipAddress = "localhost", int port = 50051, bool useTls = true, string? displayName = null, string? CertPath = null, IDictionary<string, string>? metadata = null, bool monitoringEnabled = true);
    }
}
