...
public sealed partial class Home_ServerOverview : UserControl
{
    ...
    public static readonly DependencyProperty ServerNameProperty = DependencyProperty.Register(nameof(ServerName), typeof(string), typeof(Home_ServerOverview), new PropertyMetadata(null));
}
